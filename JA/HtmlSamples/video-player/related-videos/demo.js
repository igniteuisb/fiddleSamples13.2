$(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 560,
                posterUrl: "http://igniteuisamples.dev.infragistics.local/13-2/images/samples/video-player/quince-intro-1.png",
                fullscreen: false,
                ...
                relatedVideos: [
					{
					    imageUrl: "http://igniteuisamples.dev.infragistics.local/13-2/images/samples/video-player/quince-intro-2.png",
					    title: "Quince プレゼンテーション パート 1",
